...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <br><br><p>
<div class="container">
  <center><h2 style="font-weight:100">Questão 6</h2></center>
</div>
<div class="container" id="corpoProva">
  <div class="row">
    <div class="box">
    <img src="img/questoes/questao10.png" class="img-responsive" style="margin-left: 5%; margin-top:10%;" width="90%;">
    </div>
  </div>
</div>
...
<div class="container" id="botoes">
  ...
  <a href="provacompleta5.php" id="btnAnt" type="button" class="btn btn-warning" style="margin:0.5%;">Anterior</a>
  <a href="provacompleta7.php" type="button" class="btn btn-success">Próximo</a>
</div>
