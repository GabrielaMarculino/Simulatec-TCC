...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <br><br><p>
<div class="container">
  <center><h2 style="font-weight:100">Questão 3</h2></center>
</div>
<div class="container" id="corpoProva">
  <div class="row">
    <div class="box">
    <img src="img/questoes/questao4.png" class="img-responsive" style="margin-top: 10%">
    </div>
  </div>
</div>
...
<div class="container" id="botoes">
  ...
  <a href="provacompleta2.php" id="btnAnt" type="button" class="btn btn-warning" style="margin:0.5%;">Anterior</a>
  <a href="provacompleta4.php" type="button" class="btn btn-success">Próximo</a>
</div>
