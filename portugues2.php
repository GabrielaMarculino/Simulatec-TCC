...
<div class="container" id="corpoProva">
  <div class="row">
    <div class="box">
    <img src="img/questao1.png" class="img-responsive" style="margin-top: 10%">
    </div>
  </div>
</div>
...
<div class="container" id="botoes">
  <a href="logado.php"  type="button" class="btn btn-danger">Cancelar</a>
  <a href="portugues.php" id="btnAnt" type="button" class="btn btn-warning" style="margin:0.5%;">Anterior</a>
