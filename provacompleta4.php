...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <br><br><p>
<div class="container">
  <center><h2 style="font-weight:100">Questão 4</h2></center>
</div>
<div class="container" id="corpoProva">
  <div class="row">
    <div class="box">
    <img src="img/questoes/questao5.png" class="img-responsive" style="margin-top: 10%">
    </div>
  </div>
</div>
...
<div class="container" id="botoes">
  ...
  <a href="provacompleta3.php" id="btnAnt" type="button" class="btn btn-warning" style="margin:0.5%;">Anterior</a>
  <a href="provacompleta5.php" type="button" class="btn btn-success">Próximo</a>
</div>
